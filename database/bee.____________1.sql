...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 27 2026 г., 01:09
...
(1, 'Нежные пионы', 'Пышный букет из нежных пионов, обернутые золотистой упаковочной бумагой', '2500.00', '/images/piones.png', '', '#d36ad3', 5, 'usual'),
(2, 'Летнее небо', 'Авторский букет из нежных ромашек и ароматной лаванды.', '5100.00', '/images/romashki_lavanda.png', '', '#d16969', 5, 'usual'),
(3, 'Альстромерии', 'Яркий и стойкий букет из 9 розовых альстромерий.', '3500.00', '/images/alstromerii.png', '', '#69d2d2', 8, 'usual'),
...
(6, 'Орхидеи с жемчугом', 'Пышный букет из ярких фуксийно-розовых орхидей в подарочной упаковке.', '4000.00', '/images/fuksia_orhideia.png', '', '#d068d0', 5, 'usual'),
(7, 'Тюльпаны и эустома', 'Утонченный и элегантный минималистичный букет из нежных тюльпанов.', '2000.00', '/images/tulpani.png', '', '#b3a45a', 6, 'usual'),
(8, 'Изюминка', 'Авторский, фактурный букет, который относится к современному стилю.', '5500.00', '/images/extra.png', '', '#cbb266', 6, 'usual'),
(9, 'Гжель с жемчугом', 'Фактурный букет с васильками, хлопковыми коробочками и жемчугом.', '3500.00', '/images/Vasilki.png', '', '#d6d66b', 6, 'usual'),
(10, 'Хрустальное изящество', 'Букет из нежно-розовых калл, обернутый в белую матовую бумагу.', '2500.00', '/images/hrustal.png', '', '#cf6868', 5, 'usual'),
(11, 'Французские розы', 'Букет из изысканных французских садовых роз, обернутый в стильный крафт.', '6500.00', '/images/frahc_roses.png', '', '#b9675d', 7, 'usual'),
(12, 'Для зайчиков', 'Композиция из роз и лилий, украшенная зефиром и бусинами', '8500.00', '/images/carrots.png', '/images/carrots-0.png', '#b38f59', 7, 'special'),
(13, 'Ко дню влюбленных', 'Букет из хризантем и свежей клубники для вашей второй половинки', '8000.00', '/images/strowberryes.png', '/images/strowberryes-0.png', '#9f7750', 7, 'special');
